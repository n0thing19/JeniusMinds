...
<body class="text-gray-700">
    ...
    <main class="container mx-auto px-6 py-8">
        ...
        <div class="space-y-4">
            <!-- Opsi 1 -->
            <div class="bg-brand-pink-light p-4 rounded-2xl flex items-center space-x-4 shadow-sm">
                <i class="fas fa-grip-vertical text-gray-400 drag-handle text-xl"></i>
                <input type="text" value="Answer Option 1" class="w-full bg-transparent text-lg font-semibold focus:outline-none">
            </div>
            <!-- Opsi 2 -->
            <div class="bg-brand-pink-light p-4 rounded-2xl flex items-center space-x-4 shadow-sm">
                <i class="fas fa-grip-vertical text-gray-400 drag-handle text-xl"></i>
                <input type="text" value="Answer Option 2" class="w-full bg-transparent text-lg font-semibold focus:outline-none">
            </div>
            <!-- Opsi 3 -->
            <div class="bg-brand-pink-light p-4 rounded-2xl flex items-center space-x-4 shadow-sm">
                <i class="fas fa-grip-vertical text-gray-400 drag-handle text-xl"></i>
                <input type="text" value="Answer Option 3" class="w-full bg-transparent text-lg font-semibold focus:outline-none">
            </div>
            <!-- Opsi 4 -->
            <div class="bg-brand-pink-light p-4 rounded-2xl flex items-center space-x-4 shadow-sm">
                <i class="fas fa-grip-vertical text-gray-400 drag-handle text-xl"></i>
                <input type="text" value="Answer Option 4" class="w-full bg-transparent text-lg font-semibold focus:outline-none">
            </div>
        </div>
