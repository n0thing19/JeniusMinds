...
<body class="text-gray-700">
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="container mx-auto max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="hidden md:block bg-pink-100 p-12 flex flex-col items-center justify-center text-center rounded-l-2xl" style="background-color: #EBF5FF;">
                 <img src="https://placehold.co/300x300/FFFFFF/60A5FA?text=Create" alt="Ilustrasi Membuat Akun" class="rounded-2xl mb-8 shadow-xl">
            ...
            <div class="p-8 md:p-12">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                             ...
                             <input type="text" id="fullname" name="fullname" placeholder="Enter your full name" class="w-full pl-10 pr-4 py-3 rounded-lg form-input focus:outline-none">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                           <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                            ...
                            <input type="password" id="password" name="password" placeholder="Create a password" class="w-full pl-10 pr-4 py-3 rounded-lg form-input focus:outline-none">
                        </div>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500">
                        Already have an account? <a href="#" class="font-bold brand-pink-dark hover:underline">Sign In</a>
                    </p>
                </div>
            </div>
        </div>
